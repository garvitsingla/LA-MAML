...
def main():
    ...
    os.makedirs("maml_model", exist_ok=True)
    ...
    np.save(os.path.join(env_dir, "maml_std_steps.npy"), np.array(std_steps_per_batch))
    ...
    plt.savefig(os.path.join(env_dir, "maml_plot.png"))
    plt.close()
