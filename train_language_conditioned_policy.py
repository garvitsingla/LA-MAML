...
def main():
    ...
    os.makedirs("lang_policy_model", exist_ok=True)
    torch.save({
    ...
    np.save(os.path.join(env_dir, "lang_conditioned_std_steps.npy"), np.array(std_steps_per_batch))
    ...
    plt.savefig(os.path.join(env_dir, "lang_conditioned_plot.png"))
    plt.close()
